...
export class ControladorHabitacion{
    ...
    async buscarTodos(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallamos buscando la información"+error,
                datos: [],
                estado:false
            })
        }
    ...
    async buscarPorId(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallamos buscando habitación por id"+error,
                datos:[],
                estado:false
            })
        }     
    ...
    async editar(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallamos editando habitación por id"+error,
                datos:[],
                estado:false
            })
        }  
    ...
    async eliminar(request,response){
        ...
        try{
            ...
            response.status(400).json({
                mensaje:"fallamos eliminando habitación por id"+error,
                datos:"Datos del id: "+id,
                estado:false
            })
        }
